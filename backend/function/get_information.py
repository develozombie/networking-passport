...
def lambda_handler(event, context):
    try:
        ...
        return {
            ...
            'body': json.dumps({'error': 'short_id is required and either pin or unlock_key is needed'})
        }
    ...
    try:
        ...
        print("Auth method - PIN:", pin is not None, "unlock_key:", unlock_key is not None)
        ...
        if is_using_unlock_key:
            ...
            print("Privacy settings - Share email:", share_email, "Share phone:", share_phone)
